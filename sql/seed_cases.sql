-- Seed data for Marina's 10 test cases
-- This populates the knowledge graph with known methodology breaks
...
-- Methodology Changes (Marina's 10 cases)

-- Case 1: NHIS 2019 Questionnaire Redesign (e-cigarette)
INSERT INTO methodology_changes (dataset_id, change_type, effective_date, description, impact_estimate, is_documented, source_url)
VALUES (
...
-- Case 2: NHIS 2019 (affordability)
INSERT INTO methodology_changes (dataset_id, change_type, effective_date, description, impact_estimate, is_documented, source_url)
VALUES (
    (SELECT id FROM datasets WHERE code='NHIS'),
    'questionnaire_redesign',
...
-- Case 3: CPS COVID Misclassification
INSERT INTO methodology_changes (dataset_id, change_type, effective_date, description, impact_estimate, is_documented, source_url)
VALUES (
...
-- Case 4: ACS COVID Nonresponse Bias
INSERT INTO methodology_changes (dataset_id, change_type, effective_date, description, impact_estimate, is_documented, source_url)
VALUES (
...
-- Case 5: CPI COVID Collection Suspension
INSERT INTO methodology_changes (dataset_id, change_type, effective_date, description, impact_estimate, is_documented, source_url)
VALUES (
...
-- Case 6: EU-LFS 2021 Definitional Change
INSERT INTO methodology_changes (dataset_id, change_type, effective_date, description, impact_estimate, is_documented, source_url)
VALUES (
...
-- Case 8: Eurostat Mortality Revisions
INSERT INTO methodology_changes (dataset_id, change_type, effective_date, description, impact_estimate, is_documented, source_url)
VALUES (
...
-- Case 9: ESA 2010 GDP Reclassification
INSERT INTO methodology_changes (dataset_id, change_type, effective_date, description, impact_estimate, is_documented, source_url)
VALUES (
    (SELECT id FROM datasets WHERE code='ESA2010'),
    'classification_change',
...
WHERE mc.description LIKE '%e-cigarette%' AND mc.effective_date = '2019-01-01'
...
WHERE mc.description LIKE '%affordability%'
ON CONFLICT DO NOTHING;
...
WHERE mc.description LIKE '%misclassified%'
ON CONFLICT DO NOTHING;
