"""Generic OpenAI-compatible provider — minimal fallback for any /v1 endpoint."""
...
class OpenAICompatProvider(AIProvider):
    """Provider for any OpenAI-compatible /v1 endpoint."""
        ...
        for m in data.get("data", []):
            ...
            result.append(
                ModelInfo(
                    ...
                    loaded=True,
                    capabilities=["chat", "embed"],  # Can't distinguish
                    provider="openai_compat",
